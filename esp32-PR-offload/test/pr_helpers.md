...
- `t.pr_offload_sleep()` &rarr; arm or cancel the offload MCU sleep mode using the new command channel (default wake alias = `main_rx_mirror`, i.e. GPIO33 tied to the master TX line).
