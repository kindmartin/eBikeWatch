...
class AppState:
    ...
    def __init__(self):
        ...
        self.trip_pulse_offset = 0
        self.trip_resume_pending = False
        ...
        self.sys_pmu_available = False
        self.sys_pmu_addr = None
        self.sys_vbus_v = 0.0
        self.sys_vbus_ma = 0.0
        self.sys_vbat_v = 0.0
        self.sys_batt_charge_ma = 0.0
        self.sys_batt_discharge_ma = 0.0
        self.sys_board_current_ma = 0.0
        self.sys_board_source = ""
        self.sys_power_status = {}
        self.sys_charge_status = {}
        self.sys_status_flags = ""
        self.sys_batt_last_update_ms = 0
        # Alarm dashboard / anti-theft context
        self.alarm_active = False
        self.alarm_mode = "idle"
        self.alarm_last_update_ms = 0
        self.alarm_signal_csq = None
        self.alarm_signal_rssi_dbm = None
        self.alarm_operator = ""
        self.alarm_cell_info = ""
        self.alarm_registration = ""
        self.alarm_gnss_fix = False
        self.alarm_gnss_lat = None
        self.alarm_gnss_lon = None
        self.alarm_gnss_alt = None
        self.alarm_gnss_sats = 0
        self.alarm_gnss_speed = None
        self.alarm_wifi_list = []
        self.alarm_cell_primary = ""
        self.alarm_cell_neighbors = []
        self.alarm_cell_neighbor_details = []
        self.alarm_sys_batt = None
        self.alarm_pr_batt = None
        self.alarm_snapshot = None
